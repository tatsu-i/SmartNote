  ...
  <div class="container mx-auto py-2">
    <div class="flex flex-col justify-center">
      ...
      <div class="pb-3 border-b">
        ...
        <div class="rounded-lg border border-primary/30 bg-primary/5 p-3 max-w-md my-5">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              <Sparkles class="h-5 w-5 text-primary" />
              <div>
                <h3 class="font-medium">無料プラン</h3>
                <p class="text-sm text-muted-foreground">1/5 メモ（残り1件）</p>
              </div>
            </div>
            <Button variant="outline">アップグレード</Button>
          </div>
        </div>
